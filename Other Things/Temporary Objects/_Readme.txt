Временные таблицы.
    ...
    Статистика, связанная с кэшированным временным объектом, также кэшируется
    ...
    Повторная компиляция может по-прежнему возникать по другим причинам, например, 
    если мощность таблицы изменилась на порог перекомпиляции или больше по сравнению с величиной мощности, хранящейся в кэшированном плане.
...
Табличные переменные.
    ...
    Ограничения:
        ...
        - Нельзя изменить определение переменной таблицы после ее объявления.
          Никакая инструкция DDL не может быть выполнена в переменной таблицы после ее создания.
        ...
        - Нельзя использовать INSERT INTO EXEC.
